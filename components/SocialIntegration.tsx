...
import { MessageCircle, X, Youtube, Play, ArrowRight, ChevronLeft, ChevronRight, Volume2, VolumeX, Share2 } from "lucide-react";
                        ...
                        <div className="relative w-full h-full max-w-[450px] md:h-[800px] bg-black md:rounded-3xl overflow-hidden shadow-2xl flex flex-col">
                            ...
                            <div className="absolute top-8 left-4 right-4 z-50 flex items-center justify-between text-white">
                                <div className="flex items-center gap-3 relative z-50">
                                    <div className="w-10 h-10 rounded-full border-2 border-primary p-0.5 relative overflow-hidden">
                                        <Image
                                            src={getYoutubeThumbnail(stories[activeStory].videoUrl)}
                                            alt=""
                                            fill
                                            sizes="40px"
                            ...
                            <div className="flex-1 relative bg-black flex items-center justify-center">
                                {activeStory !== null && (
                                    <iframe
                                        src={`https://www.youtube.com/embed/${getVideoId(stories[activeStory].videoUrl)}?autoplay=1&mute=${isMuted ? 1 : 0}&controls=0&rel=0&showinfo=0&iv_load_policy=3&modestbranding=1`}
